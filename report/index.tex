      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}
          \begin{axis}[
            ...
            \addplot coordinates { (10, 7.71) (20, 7.49) (40, 7.19) (80, 9.34)};
            \addlegendentry{Multi Core}

            \addplot coordinates { (10, 9.68) (20, 9.68) (40, 9.68) (80, 9.68)};
      ...
      \begin{figure}[H]
        ...
        \begin{tikzpicture}
          \begin{axis}[
            ...
            \addplot coordinates { (10, 7.17) (20, 7.125) (40, 6.95) (80, 6.96)};
            \addlegendentry{Multi Core}
